...
public class Memory {
    ...
    private static final List<List<String[]>> pr = new ArrayList<>();
    private static final String[][] cpu = new String[16][2];
    private static final String[][] hdd = new String[10][2];
    ...
    static {
        for (int i = 0; i < 16; i++) freeLines.add(i);
    }
